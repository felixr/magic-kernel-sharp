...
TEST(ExternalFile, BadModes) {
  ...
  string_new_f(
      ...
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "cat"), e);
  string_delete(&e);
  ...
  string_new_f(
      ...
      "(mode 'rt' file '%s')",
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "rt"), e);
  string_delete(&e);
  external_file_delete(&ef);
  string_new_f(
      &e,
      "Could not open external file '%s' with mode 'rr'",
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "rr"), e);
  string_delete(&e);
  external_file_delete(&ef);
  string_new_f(
      &e,
      "Could not open external file '%s' with mode 'rw'",
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "rw"), e);
  string_delete(&e);
  external_file_delete(&ef);
  string_new_f(
      &e,
      "Could not open external file '%s' with mode 'br'",
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "br"), e);
  string_delete(&e);
  external_file_delete(&ef);
  string_new_f(
      &e,
      "Could not open external file '%s' with mode 'r++'",
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "r++"), e);
  string_delete(&e);
  external_file_delete(&ef);
  string_new_f(
      &e,
  ...
  string_new_f(
      ...
      "Cannot include both 'a' and 'r' in mode (mode 'ar' file '%s')",
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "ar"), e);
  string_delete(&e);
  external_file_delete(&ef);
  string_new_f(
      &e,
      ...
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "ra"), e);
  string_delete(&e);
  external_file_delete(&ef);
  string_new_f(
      &e,
      ...
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "aw"), e);
  string_delete(&e);
  external_file_delete(&ef);
  string_new_f(
      &e,
      ...
      filename);
  EXPECT_DEATH(external_file_new(&ef, filename, "wa"), e);
  string_delete(&e);
  external_file_delete(&ef);
...
TEST(ExternalFile, WriteRead) {
   ...
   */
  EXPECT_FALSE(external_file_try_read_byte(ef, &b));
  string_new_f(
      &e,
      "Could not read byte from '%s'",
      filename);
  EXPECT_DEATH(external_file_read_byte(ef), e);
  string_delete(&e);
  external_file_delete(&ef);
  ...
  */
  ...
  string_new_f(
      ...
      filename);
  EXPECT_DEATH(external_file_write_byte(ef, 1), e);
  string_delete(&e);
  EXPECT_FALSE(external_file_is_eof(ef));
  external_file_fast_forward(ef);
  EXPECT_TRUE(external_file_is_eof(ef));
  EXPECT_FALSE(external_file_try_read_byte(ef, &b));
  string_new_f(
      &e,
...
TEST(ExternalFile, Append) {
  ...
  /* Test that reading an append-only file fails.
   */
  EXPECT_FALSE(external_file_try_read_byte(ef, &b));
  string_new_f(
      &e,
